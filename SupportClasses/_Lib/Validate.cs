                ...
                if (strExpression.Length > 0)
                {
                    foreach (char c in strExpression)
                    {
                        if (Char.IsDigit(c))
                            ...
                            blnSomethingElse = true;

                        if (blnAlpha && blnNumeric && blnSomethingElse)
                            break;
                    }

                    if (blnNumeric && !blnAlpha && !blnSomethingElse)
                    {
                        return Type.xPression.Numeric;
                    }
                    else if (!blnNumeric && blnAlpha && !blnSomethingElse)
                    {
                    ...
                    {
                        return Type.xPression.NonAlphaNumeric;
                    }
                    else
