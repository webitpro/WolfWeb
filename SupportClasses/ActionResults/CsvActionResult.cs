...
namespace WebIT.Temp
{
    ...
    public class CsvActionResult<T> : ActionResult where T : class
    {
        ...
        ///     </code>
        /// </example>
        public CsvActionResult(IEnumerable<T> enumerable, string file_name, string[] properties, string[] columnHeaders)
        {
